...
public class HomeControllerTest {
    ...
    /**
     * TEST TAMBAHAN UNTUK MENGHILANGKAN BARIS KUNING DI palingTer
     * Mencakup semua skenario yang mungkin terjadi.
     */
    @Test
    void testPalingTer_FullBranchCoverage() {
        ...
        // "  " (dua spasi) akan menghasilkan word kosong setelah di-split
        ...
        // Untuk memastikan if (e.getValue() > maxCount) diuji untuk kondisi true dan false.
        ...
        // Hasil: terbaik=3, terendah=2, terburuk=1 -> Pemenang 'terbaik'
